...
- **Oxygen** (05/19/2026): Skill packs — `packs:` section in `skilltree.yml`, `PackDependency` references (local + remote), full-entry members supporting multi-repo composition, all-or-nothing v1, nested-packs door left open. See [docs/specs/packs.md](specs/packs.md).
